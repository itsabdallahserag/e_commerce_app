...
class DeleteItemCartUseCase{
  ...
  DeleteItemCartUseCase({required this.getCartRepository});
  Future<GetCartResponce> invoke (String productId) {
    return getCartRepository.deleteProductFromCart(productId);
  }
}